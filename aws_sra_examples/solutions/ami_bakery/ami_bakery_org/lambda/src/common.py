...
def get_active_organization_accounts(exclude_accounts: list) -> list:
...
def get_account_ids(accounts: list, exclude_accounts: list) -> list:
    ...
    if not accounts:
        accounts = get_active_organization_accounts(exclude_accounts)
