...
class sra_staging:
    ...
    STAGING_BUCKET: str = "sra-staging-"  # todo(liamschn): set a default value??
    ...
    def prepare_code_for_staging(self, staging_upload_folder, staging_temp_folder, solutions_dir):
        ...
        # # Debugging output:
        # stage_dir = "staged files:\n"
        # temp_dir = "temp files:\n"
        # for root, dirs, files in os.walk(os.path.join(staging_upload_folder, "sra-common-prerequisites")):
        #     for name in files:
        #         stage_dir = stage_dir + os.path.join(root, name) + "\n"
        #         # self.LOGGER.info(os.path.join(root, name))
        #     for name in dirs:
        #         stage_dir = stage_dir + os.path.join(root, name) + "\n"
        #         # self.LOGGER.info(os.path.join(root, name))
        # for root, dirs, files in os.walk(os.path.join(staging_temp_folder, "sra-common-prerequisites")):
        #     for name in files:
        #         temp_dir = temp_dir + os.path.join(root, name) + "\n"
        #         # self.LOGGER.info(os.path.join(root, name))
        #     for name in dirs:
        #         temp_dir = temp_dir + os.path.join(root, name) + "\n"
        #         # self.LOGGER.info(os.path.join(root, name))

        # self.LOGGER.info(stage_dir)
        # self.LOGGER.info(temp_dir)
