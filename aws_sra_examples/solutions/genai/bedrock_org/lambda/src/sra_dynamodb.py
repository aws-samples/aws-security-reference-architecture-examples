...
if TYPE_CHECKING:
    ...
    from mypy_boto3_dynamodb.type_defs import UpdateItemOutputTableTypeDef, DeleteItemOutputTableTypeDef, KeySchemaElementTypeDef, AttributeDefinitionTypeDef, ProvisionedThroughputTypeDef
